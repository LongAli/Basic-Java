 ...
 * evaluate. The class allows user to calculate the division of two variables
 */
 ...
 */
 ...
 public class Quotient extends ArithmeticExpression{
    ...
    */
    public Quotient(ArithmeticExpression b, ArithmeticExpression c){
      operand1 = b;
      operand2 = c;
    }
    ...
    * @return the Quotient of the result of ArithmeticExpression
    */
    @Override
    public Value evaluate(){
      ...
      if (operand1 == null || operand2 == null){
        ...
        if (v1 instanceof IntEvaluable && v2 instanceof IntEvaluable){
          ...
          //check if demoninator is zero
          if (temp2 != 0){
            //calculate the difference the valid inputs
