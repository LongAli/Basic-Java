 ...
 * evaluate. The class allows users to sum two variable
 */
 ...
 */
 ...
 public class Sum extends ArithmeticExpression{
    ...
    */
    public Sum(ArithmeticExpression b, ArithmeticExpression c){
      operand1 = b;
      operand2 = c;
    }
    ...
    * @return the Sum of the result of ArithmeticExpression
    */
    @Override
