 ...
 * evaluate. The class allows user to calculate the Difference of two variables
 */
 ...
 */
 ...
 public class Difference extends ArithmeticExpression{
    ...
    */
    public Difference(ArithmeticExpression b, ArithmeticExpression c){
      operand1 = b;
      operand2 = c;
    }
    ...
    * @return the Difference of the result of ArithmeticExpression
    */
    @Override
