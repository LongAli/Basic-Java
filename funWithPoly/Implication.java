 ...
 * The class allows users to check whether the first variable implies the second
 * variable.
 */
 ...
 */
 ...
 public class Implication extends BooleanExpression{
    ...
    */
    public Implication(BooleanExpression b, BooleanExpression c){
      operand1 = b;
      operand2 = c;
    }
    ...
    * @return the Implication of the result of BooleanExpression
    */
    @Override
