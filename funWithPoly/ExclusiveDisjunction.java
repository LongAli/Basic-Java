 ...
 * The class allows users to check if the two results are different
 */
 ...
 */
 ...
 public class ExclusiveDisjunction extends BooleanExpression{
    ...
    */
    public ExclusiveDisjunction(BooleanExpression b, BooleanExpression c){
      operand1 = b;
      operand2 = c;
    }
    ...
    * @return the ExclusiveDisjunction of the result of BooleanExpression
    */
    @Override
    public Value evaluate(){
      if (operand1 == null || operand2 == null){
        ...
        if ((v1 instanceof BoolEvaluable) && (v2 instanceof BoolEvaluable)){
          ...
          //check if two booleans are not equivalent
          if (temp1 != temp2){
